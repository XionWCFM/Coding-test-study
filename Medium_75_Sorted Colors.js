...
빨간색, 흰색 또는 파란색으로 채색된 n개의 객체가 있는 배열 번호가 주어지면
...
// [0, 1, 2, 1, 1, 2, 0]  start=0, idx=1, end=6        :  start +1, idx +1
// [0, 1, 0, 1, 1, 2, 2]  start=1, idx=2, end=6        :  end -1
// [0, 1, 0, 1, 1, 2, 2]  start=1, idx=2, end=5        :  start +1 idx +1
// [0, 0, 1, 1, 1, 2, 2]  start=2, idx=3, end=5        :  idx +1
// [0, 0, 1, 1, 1, 2, 2]  start=2, idx=4, end=5        :  idx +1
// [0, 0, 1, 1, 1, 2, 2]  start=2, idx=5, end=5        :  break
